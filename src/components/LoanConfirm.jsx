...
export default function LoanConfirm({
  ...
  return (
    <div
      className={
        "absolute w-[90%] left-[50%] top-[50%] md:w-[500px] -translate-x-[50%] -translate-y-[50%] bg-[#22437c] mx-auto rounded-xl pb-8 pt-5 p-2 md:p-5 shadow-xl transition duration-200 scale-0 z-20 " +
        (isShow ? "scale-100" : "")
      }
    >
